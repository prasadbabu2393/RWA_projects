...
//   {962.000f, 7.000000f}, {969.100f, 8.000000f}, {975.000f, 9.000000f}, {980.000f, 10.000000f},
...
//             <a href="/" class="nav-button"> Configuration</a>
...
//                 document.getElementById("ch0").innerText = data.voltage1.toFixed(3) + " V";
//                 document.getElementById("ch1").innerText = data.voltage2.toFixed(3) + " V";
//                 document.getElementById("ch2").innerText = data.voltage3.toFixed(3) + " V";
//                 document.getElementById("ch3").innerText = data.voltage_diff.toFixed(3) + " V";
...
//             <a href="/" class="nav-button"> WiFi Configuration</a>
...
//     <a href="/vacuum" class="back-link" style="margin-top: 10px;"> Vacuum Display</a>
//     <a href="/data" class="back-link" style="margin-top: 10px;"> Live Data</a>
//   </div>
...
void setup() {
    ...
    if (WiFi.status() == WL_CONNECTED) {
        ...
        Serial.println("WiFi configuration at: http://" + WiFi.localIP().toString() + "/config");
    } else {
        Serial.println("Ready! Connect to SoftAP and access: http://192.168.4.1");
        Serial.println("WiFi configuration at: http://192.168.4.1/config");
    }
}
...
<body>
    <div class="container">
        ...
        <div class="button-container">
            <a href="/config" class="nav-button"> WiFi Configuration</a>
            <a href="/vacuum" class="nav-button"> Vacuum Display</a>
            <a href="/update" class="nav-button"> OTA Update</a>
        </div>
    </div>
